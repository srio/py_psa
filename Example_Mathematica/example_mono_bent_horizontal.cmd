...
MatrixTempX=
MatrixFlight[z0].
MatrixMonoBent[bMono0,thetaB0, Fc0,CoefX0].
MatrixFlight[z1].
{x,xp,dl};
...
NewSourceX[x_,xp_,dl_]=NewSourceX[x,xp,dl]*AcceptanceAngleMonoBent[ MatrixTempX[[1]], MatrixTempX[[2]], MatrixTempX[[3]], Alpha0, thetaB0, Wd0, RowlandRadius0, RMono0, Rint0 ];
...
NewSourceX[x_,xp_,dl_]=NewSourceX[x,xp,dl]*AcceptanceWaveMonoBent[ MatrixTempX[[3]], thetaB0, DfS0, Wd0, SigmaXSource ];
