...
MatrixTempX=
MatrixFlight[z0].
MatrixMonoMosaic[thetaB0,CoefX0].
MatrixFlight[z1].
{x,xp,dl};
...
NewSourceX[x_,xp_,dl_]=NewSourceX[x,xp,dl]*AcceptanceAngleMonoMosaic[ MatrixTempX[[2]], MatrixTempX[[3]], thetaB0, eta0, RMono0, Rint0 ];
...
NewSourceX[x_,xp_,dl_]=NewSourceX[x,xp,dl]*AcceptanceWaveMonoMosaic[ MatrixTempX[[3]], BMonoX*SigmaXPSource, thetaB0, eta0 ];
