...
(* Parameters for the 0. Element: Compound Refractive *)
(* Lens with parabolic holes *)
                                            
F0 = 7.352941*10^3;
Radius0 = 1.000000*10^1;
DistBetwHoles0 = 1.000000*10^0;
Sigma0 = 3.696394*10^-1;
...
NewSourceX[x_,xp_,dl_]=NewSourceX[x,xp,dl]*AcceptanceCompLensPara[ MatrixTempX[[1]], Radius0, DistBetwHoles0, Sigma0 ];
NewSourceY[y_,yp_,dl_]=NewSourceY[y,yp,dl]*AcceptanceCompLensPara[ MatrixTempY[[1]], Radius0, DistBetwHoles0, Sigma0 ];
