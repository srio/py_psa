...
# object definition
Lens = ['LensParabolic2D', Radius0, DistBetwHoles0, Sigma0, matrixCompLensPara(F0), matrixCompLensPara(F0)]
ListObject = [Lens]
...
# Results mathematica
fluxM = 1.28189*10**-20
sigmaxyM = [1.90707991e-01 , 9.90504563e-02]
sigmaxpypM = [1.45663785e+01, 1.25251185e+01]
